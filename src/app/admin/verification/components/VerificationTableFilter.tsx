      ...
      <PopoverContent bg={backgroundColor} p={5} maxW="400px" w={"100%"}>
        ...
        <PopoverBody>
          <FormControl mt={4}>
            ...
            >
              <option value="This month">International Passport</option>
              <option value="Quarterly">Voter’s Card</option>
              <option value="Quarterly">Driver’s License</option>
              <option value="Quarterly">National ID Card</option>
            </Select>
          </FormControl>
          <FormControl mt={4}>
            ...
            //   onChange={handleChange}
            >
              <option value="This month">Bank Statement</option>
              <option value="Quarterly">Tenancy Agreement</option>
              <option value="Quarterly">Tax Document</option>
              <option value="Quarterly">Utility Bill</option>
            </Select>
          </FormControl>
          <FormControl mt={4}>
            ...
            //   onChange={handleChange}
            >
              <option value="This month">Verified</option>
...
export default VerificationTableFilter;
