  ...
  return (
    ...
    >
      ...
      <PopoverContent bg={backgroundColor} p={5} maxW="400px" w={"100%"}>
        ...
        <PopoverBody>
          <FormControl>
            <FormLabel>Verififcation</FormLabel>
            <Select
            //   value={filter}
            //   onChange={handleChange}
            >
              <option value="This week">All</option>
              <option value="This month">Verified</option>
              <option value="Quarterly">Pending</option>
              <option value="Yearly">Rejected</option>
            </Select>
          </FormControl>
          <FormControl mt={4}>
            ...
            >
              <option value="This week">All</option>
              <option value="This month">Active</option>
              <option value="Quarterly">Inactive</option>
              <option value="Quarterly">Flagged</option>
            </Select>
          </FormControl>
          <FormControl mt={4}>
...
export default SendersTableFilter;
