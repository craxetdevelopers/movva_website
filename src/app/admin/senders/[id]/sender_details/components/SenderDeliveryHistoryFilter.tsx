...
const SenderDeliveryHistoryFilter = () => {
      ...
      <PopoverContent bg={backgroundColor} p={5} maxW="400px" w={"100%"}>
        ...
        <PopoverBody>
          <FormControl mt={4}>
            ...
            <Input ref={initialRef} placeholder="DR002119" />
          </FormControl>
          <FormControl mt={4}>
            ...
            >
              ...
              <option value="Quarterly">Incomplete</option>
              <option value="Quarterly">Cancelled</option>
            </Select>
          </FormControl>
          <FormControl mt={4}>
...
export default SenderDeliveryHistoryFilter;
