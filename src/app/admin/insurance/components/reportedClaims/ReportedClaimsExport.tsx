...
import { Button, Checkbox, Flex, FormControl, FormLabel, Heading, Icon, Input, InputGroup, InputRightElement, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverFooter, PopoverHeader, PopoverTrigger, Radio, RadioGroup, Select, Stack, useColorModeValue } from "@chakra-ui/react";
...
const ReportedClaimsExport = () => {
  ...
  return (
    ...
    >
      <PopoverTrigger>
        <Button bg={"#2C2F66"} color={"#fff"} px={'35px'}>
...
export default ReportedClaimsExport;
