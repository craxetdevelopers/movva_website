...
import ReportedClaimsExport from "./ReportedClaimsExport";
import AddClaims from "../AddClaims";
import ReportedClaimsFilter from "./ReportedClaimsFilter";
import ReportedClaimsStatistic from "./ReportedClaimsStatistic";
    ...
    <Stack>
      <Flex mt={"50px"} gap={"20px"}>
        ...
        <Flex w={"100%"} gap={"10px"} justifyContent={"end"}>
          ...
          <ReportedClaimsFilter />
          <Button bg={"none"}> Clear all</Button>
        </Flex>
      </Flex>
      <ReportedClaimsStatistic />
      {/* <LiveInsuredTable /> */}
    </Stack>
  );
};
