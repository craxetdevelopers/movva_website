...
const MovvaPayoutHistoryFilter = () => {
  ...
  return (
    ...
    >
      ...
      <PopoverContent bg={backgroundColor} p={5} maxW="400px" w={"100%"}>
        ...
        <PopoverBody>
          <FormControl mt={4}>
            <FormLabel>Payout ID</FormLabel>
            <Input ref={initialRef} placeholder="P123456" />
          </FormControl>
          <FormControl mt={4}>
            ...
            >
              ...
              <option value="Quarterly">Declined</option>
...
export default MovvaPayoutHistoryFilter;
